...
| X 轴标签对齐       | 最左标签左对齐、最右标签右对齐、中间标签居中对齐                                                                                                                                    |
| 首尾标签防裁切       | `alignMinLabel:'left'` + `alignMaxLabel:'right'`；如使用原生 ECharts 还可选 `grid.containLabel:true` 让 ECharts 自动为坐标轴标签撑出空间                                          |
| 轴刻度线          | 默认不显示                                                                                                                                                       |
| 轴标题           | 默认不显示                                                                                                                                                       |
...
| 项 | base | iFinD-PC | Ainvest | THS |
| --- | --- | --- | --- | --- |
| 涨 / 跌色 | `#FF2436` / `#07AB4B` | **`#eb5454` / `#47b262`**（红涨绿跌浅色版） | — | — |
